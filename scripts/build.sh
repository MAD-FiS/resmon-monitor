...
tar -czvf tmp.tar.gz common complex_meas_processor config rest_api sensor_receiver .monitor-root resmon-monitor resmon-monitor.env README.md jwt.key >> /dev/null
