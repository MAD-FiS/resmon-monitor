...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Sensor monitor', epilog='Example usage: python3 main.py -p 8083 -c ./cert.pem -k ./key.pm')
    ...
    while True:
        if not server.is_running:
            ...
            #Tu moze isc cala reszta operacji monitora
